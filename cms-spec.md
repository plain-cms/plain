...
- **C3. Readable in one sitting.** The entire core (`build.js` + `lib/` + admin JS, excluding themes/plugins/content) must stay under **2,600 lines**. No single file over 500 lines. If a feature can't fit, it becomes a plugin.
