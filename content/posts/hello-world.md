...
title: Hello, world
date: 2026-07-01
description: Your site is live. Here is what just happened, and what to do next.
cover: /media/2026/07/og-image.png
tags:
  - example
draft: false
example: true
...
If you can read this, your site is live. 
Yay! There is no server to maintain, no database to back up, and no bill arriving next month — the whole site is a folder of plain files, published as fast static pages.
...
2. Rewrite the [About](/about/) page.
3. Write your final post — then delete these example ones.
