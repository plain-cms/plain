// lib/markdown.js — Markdown rendering: marked, configured (cms-spec.md §6 step 4).
//
// GFM tables and code fences work out of the box. We add:
//   - heading anchors: every heading gets a stable slug id
//   - external links get rel="noopener"
//   - images get loading="lazy" decoding="async" (no server image pipeline, §7)
//
// Isomorphic: strings in, strings out. The admin reuses this module in the
// browser so previews match the build byte for byte (§10.2).
